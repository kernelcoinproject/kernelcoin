Contributing to Kernelcoin Core
============================

The Kernelcoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Kernelcoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/kernelcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to kernelcoin-qt
...
The following applies to code changes to the Kernelcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Kernelcoin
Network Protocol consensus changes.

Whether a pull request is merged into Kernelcoin Core rests with the project merge
...
Patches that change Kernelcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Kernelcoin consensus, it must have been
...
The project leader is the release manager for each Kernelcoin Core release.
