...
bech32_templates = [
  ...
  ('kcn',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('kcn',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('kcn',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('kcn',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tkcn',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tkcn',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tkcn',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tkcn',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tkcn',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tkcn',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tkcn',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tkcn',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rkcn',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rkcn',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rkcn',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rkcn', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tkcn',   17, 32, Encoding.BECH32M, False, False, False),
  ('rkcn',  3,  1, Encoding.BECH32M, False, False, False),
  ('kcn',   15, 41, Encoding.BECH32M, False, False, False),
  ('tkcn',    0, 16, Encoding.BECH32,  False, False, False),
  ('rkcn',  0, 32, Encoding.BECH32,  True,  False, False),
  ('kcn',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tkcn',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rkcn',  0, 20, Encoding.BECH32,  False, False, True),
  ('kcn',    0, 20, Encoding.BECH32M, False, False, False),
  ('tkcn',    0, 32, Encoding.BECH32M, False, False, False),
  ('rkcn',  0, 20, Encoding.BECH32M, False, False, False),
  ('kcn',    1, 32, Encoding.BECH32,  False, False, False),
  ('tkcn',    2, 16, Encoding.BECH32,  False, False, False),
  ('rkcn', 16, 20, Encoding.BECH32,  False, False, False),
]
