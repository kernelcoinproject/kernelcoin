...
"""Verify that starting kernelcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start kernelcoin with -h for help text")
        ...
        self.log.info("Start kernelcoin with -version for version information")
        ...
        self.log.info("Start kernelcoind with -fakearg to make sure it does not start")
