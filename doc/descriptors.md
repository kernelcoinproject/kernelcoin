# Support for Output Descriptors in Kernelcoin Core

Since Kernelcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `kcn1...` for mainnet or `tkcn1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Kernelcoin Core wallets, a convenience function `combo` is
