...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " kernelcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  kernelcoin-tx [options] <hex-tx> [commands]  Update hex-encoded kernelcoin transaction\n" +
            "or:     kernelcoin-tx [options] -create [commands]   Create hex-encoded kernelcoin transaction\n" +
            "\n";
